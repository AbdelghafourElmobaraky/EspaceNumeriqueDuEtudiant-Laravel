            ...
            <div class="main-content-inner">
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Attestation Scolarité</li>
                    </ul><!-- /.breadcrumb -->
                ...
                <div class="page-content">
                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small>
                                ...
                                Formulaire de demande d'attestation Scolarité
                            </small>
                        </h1>
                    </div><!-- /.page-header -->
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="col-sm-8 col-sm-offset-2" id="widget-container-col-3">
                                <div class="widget-box widget-color-orange collapsed" id="widget-box-3">
                                    <div class="widget-header widget-header-small">
                                        <h6 class="widget-title">
                                            <i class="ace-icon fa fa-sort"></i>
                                            Notifications attestation de Scolarité
                                        </h6>
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            @if ($demandeattestation)
                                                @if ($demandeattestation->status == 1)
                                                    <p class="alert alert-success">Votre Attestation de scolarité a été <strong>Acceptée</strong>  </p>
                                                @else
                                                    <p class="alert alert-danger">Votre Attestation de scolarité est en cour de Accepter</p>
                                                @endif

                                                @if ($demandeattestation->status == 1 && $demandeattestation->signee == 1)
                                                    <p class="alert alert-success">Votre Attestation de scolarité a été <strong>Signée</strong></p>
												@endif
                                                @if ($demandeattestation->status == 1 && $demandeattestation->signee == 0)
                                                    <p class="alert alert-danger">Votre Attestation de scolarité est en cour de signature</p>
                                                @endif
                                            @else
                                                <p class="alert alert-info">Aucune demande d'attestation de scolarité trouvée.</p>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-8 col-sm-offset-2">
                                    <div class="widget-box">
                                        <div class="widget-header">
                                            <h4 class="widget-title">Demandes Attestation Scolarité</h4>
                                                    ...
                                                    <fieldset>
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" id="cne"
                                                                name="cne" value="{{ $etudiant->cne }}" readonly>
                                                        </div>
                                                        <br>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="{{ $etudiant->prenom }}" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <br>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="{{ $diplome->diplome }}" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="diplome" name="filiere"
                                                                        value="{{ $filiere->filiere }}" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
