            ...
            <div class="main-content-inner">
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Retrait De Bac</li>
                    </ul><!-- /.breadcrumb -->
                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small>
                                ...
                                Formulaire de demande de Retrait du Bac
                            </small>
                        </h1>
                    </div><!-- /.page-header -->
                                ...
                                <div class="widget-box widget-color-orange collapsed" id="widget-box-3">
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
											@if ($demandebac)
												@if ($demandebac->status == 1)
													<p class="alert alert-success">Votre demande de retrait du Bac a été <strong>acceptée</strong>.</p>
												@else
													<p class="alert alert-danger">Votre demande de retrait du Bac est en cours de traitement.</p>
												@endif
											@else
												<p class="alert alert-info">Aucune demande de retrait du Bac trouvée.</p>
											@endif
										</div>
                                ...
                                <div class="col-sm-8 col-sm-offset-2">
                                    <div class="widget-box">
                                        <div class="widget-header">
                                            <h4 class="widget-title">Demande Retrait de Bac</h4>
                                        ...
                                        <div class="widget-body">
                                            <div class="widget-main no-padding">
                                                <form action="{{ route('DemandeBac.store') }}" method="POST">
                                                    @csrf
                                                    <!-- <legend>Form</legend> -->
                                                    <fieldset>
                                                        <div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <input type="radio" id="provisoire"
                                                                        value="provisoire" name="type"
                                                                        class="custom-control-input" required>
                                                                    <label class="custom-control-label"
                                                                        for="provisoire">Provisoire</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <input type="radio" id="definitif"
                                                                        value="definitif" name="type"
                                                                        class="custom-control-input" required>
                                                                    <label class="custom-control-label"
                                                                        for="definitif">Définitif</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </fieldset>
