                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="hidden-sm hidden-xs action-buttons">
                                                                ...
                                                                @else
                                                                    <form
                                                                        action="{{ route('DemandeReleveDeNote.markAsRead', ['id' => $demande->id]) }}"
                                                                ...
                                                                @else
                                                                    <form
                                                                        action="{{ route('DemandeReleveDeNote.markAsSignee', ['id' => $demande->id]) }}"
                                                                        method="POST" style="display: inline">
                                                                        @csrf
                                                                        <button class="green">
                                                                            <i
                                                                ...
                                                                @if ($demande->terminer)
                                                                    ...
                                                                    @else
                                                                        <form
                                                                            action="{{ route('DemandeReleveDeNote.markAsRefuser', ['id' => $demande->id]) }}"
                                                                            method="POST" style="display: inline">
                                                                            @csrf
                                                                            <button class="red">
                                                                                <i
