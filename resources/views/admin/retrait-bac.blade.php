...
<body class="no-skin">
    ...
    @section('notification','{{ $notificationCount }}')
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="hidden-sm hidden-xs action-buttons">
                                                                ...
                                                                @else
                                                                    <form
                                                                        action="{{ route('DemandeBac.markAsRead', ['id' => $demande->id]) }}"
                                                                ...
                                                                @if ($demande->terminer)
                                                                    ...
                                                                    @else
                                                                        <form
                                                                            action="{{ route('DemandeBac.markAsRefuser', ['id' => $demande->id]) }}"
                                                                            method="POST" style="display: inline">
                                                                            @csrf
                                                                            <button class="red">
                                                                                <i
