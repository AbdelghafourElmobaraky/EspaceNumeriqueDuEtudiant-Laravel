            ...
            <ul class="nav ace-nav">
                                    ...
                                    <a href="{{ route('DemandeBac.show') }}">
                                        <div class="clearfix">
                                            ...
                                            <span class="pull-right badge badge-info">
                                                {{-- @php
                                                    $bacCount = isset($bacCount) ? $bacCount : 0;
                                                @endphp --}}
                                                +{{ $bacCount }}
                                            </span>
                                        </div>
                                ...
                                <li>
                                    <a href="{{ route('DemandeAttestation.show') }}">
                                        <div class="clearfix">
                                           ...
                                           <span class="pull-right badge badge-success">{{ $attestationCount }}</span>
                                       </div>
                                    </a>
                                </li>
                            @endif
                                ...
                                <li>
                                    <a href="{{ route('DemandeReleveDeNote.show') }}">
                                       <div class="clearfix">
                                            ...
                                            <span class="pull-right badge badge-success">{{ $releveCount }}</span>
                                        </div>
                                    </a>
                                </li>
                            @endif
                ...
                <li class="light-blue dropdown-modal">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <img class="nav-user-photo" src="{{ asset('storage/profil_images/' . $user->profile_img) }}" alt="Jason's Photo" />
                    ...
                    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        <li>
                            <a href="{{ route('profileAdmin.edit',$user->id  ) }}">
