				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Diplôme & Filière</li>
						</ul><!-- /.breadcrumb -->
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="widget-box">
											<div class="widget-header">
												<h4 class="widget-title">Ajouter un Diplôme</h4>
											...
											<div class="widget-body">
												<div class="widget-main no-padding">
													<form action="{{ route('Diplome.store') }}"  method="POST">
														...
														<fieldset>
															<div>
																<label for="id_diplome">Diplôme ID</label>
																<input type="text" class="form-control" id="id_diplome" name="id_diplome">
															</div>
															<br>
															<div>
															...
															<div>
																...
																<input type="text" class="form-control" id="form-field-select-1">
															</div>
														</fieldset>
									...
									<div class="col-sm-6">
										<div class="widget-box">
											<div class="widget-header">
												<h4 class="widget-title">Ajouter un Filière</h4>
												<span class="widget-toolbar">
													<a href="#" data-action="settings">
														<i class="ace-icon fa fa-cog"></i>
													</a>
											...
											<div class="widget-body">
												<div class="widget-main no-padding">
													<form action="{{ route('Filiere.store') }}" method="POST">
														...
														<fieldset>
															<div>
																<label for="id_filiere">Filière ID</label>
																<input type="text" class="form-control" id="id_filiere" name="id_filiere">
															</div>
															<br>
															<div>
