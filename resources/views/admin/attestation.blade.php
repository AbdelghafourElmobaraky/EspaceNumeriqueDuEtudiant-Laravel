                                        ...
                                        <table id="dynamic-table"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Diplome</th>
                                                    <th class="hidden-480">Filiere</th>
                                                    <th>Semestre</th>
                                            ...
                                            <tbody>
                                                @foreach ($attestation as $demande)
                                                    <tr>
                                                        <td class="center">{{ $demande->cne }}</td>
                                                        <td><a href="#">{{ $demande->nom }}</a></td>
                                                        <td>{{ $demande->prenom }}</td>
                                                        <td>{{ $demande->diplome }}</td>
                                                        <td>{{ $demande->Filiere }}</td>
                                                        <td>{{ $demande->semestre }}</td>
                                                        {{-- <td class="hidden-480">
                                                            ...
                                                            <div class="hidden-sm hidden-xs action-buttons">
                                                                @if ($demande->status)
                                                                    <span class="badge badge-success"><i
                                                                            class="ace-icon fa fa-check bigger-120"></i></span>
                                                                @else
                                                                    <form
                                                                        action="{{ route('DemandeAttestation.markAsRead', ['id' => $demande->id]) }}"
                                                                ...
                                                                @else
                                                                    <form
                                                                        action="{{ route('DemandeAttestation.markAsSignee', ['id' => $demande->id]) }}"
                                                                        method="POST" style="display: inline">
                                                                        @csrf
                                                                        <button class="green">
                                                                            <i
                                                                ...
                                                                @if ($demande->terminer)
                                                                    <span class="badge badge-success"><i
                                                                            class="ace-icon fa fa-trash-o bigger-130"></i>/span>
                                                                    @else
                                                                        <form
                                                                            action="{{ route('DemandeAttestation.markAsRefuser', ['id' => $demande->id]) }}"
                                                                            method="POST" style="display: inline">
                                                                            @csrf
                                                                            <button class="red">
                                                                                <i
